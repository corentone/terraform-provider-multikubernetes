...
require (
	...
	github.com/hashicorp/terraform-provider-kubernetes v1.13.4-0.20240108150423-ccd97a787308
)
...
replace github.com/hashicorp/terraform-provider-kubernetes => github.com/corentone/terraform-provider-kubernetes v0.0.0-20240213000627-e18070568690
